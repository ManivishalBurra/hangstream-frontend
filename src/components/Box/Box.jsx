...
const Box = (props) => {
  ...
  function UpdateMovieDB(e) {
    ...
    if (id.substring(0, 2) !== "tt") {
      ...
      var options = {
        ...
        headers: {
          "x-rapidapi-key":
            "fe88b7cda7mshfee26075322cbb7p1eb01cjsn302c1761040b",
          "x-rapidapi-host": "imdb8.p.rapidapi.com",
        },
      };
      if (id.includes("tt")) {
  ...
  function PrivateUpload(e) {
    ...
    if (!exist) {
      ...
      axios
        .post(`${BASE_URL}/private/uploadexist`, {
          url: url,
          episode: episode,
          movieID: movieID,
        })
  ...
  return (
    <div className="login-main box-main center backdrop-blur-black">
      <div className="login-box center column">
        {exist && (
          <h6>Already exists in our DB,add an episode if you want to...</h6>
        )}
        {props.filePath ? (
          <>
          ...
          <form className="center column">
            <div className="movie-name center">
              <input
                ...
                label="Drive url"
              />
              <button onClick={GiveSuggestions}>
                <SearchIcon />
              </button>
            </div>
            <input
            ...
            {!props.private ? (
              ...
              <button id="Submit-btn" onClick={PrivateUpload} disabled={enable}>
                Upload
              </button>
            )}
          </form>
