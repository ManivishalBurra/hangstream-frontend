...
=======
>>>>>>> d4b5af7ee86b684c8e16931a9ef96df6c102979a
    }
    else if (roomId) {
      ...
      <div className="row home-hero" id={theme+"-main"}>
        <div className="col-lg-8 ">
          ...
          <div className="center stream-choice">
            <button className="stream-option center" onClick={CreateRoomDiv}><img src={streamcam} />&nbsp;&nbsp;Start stream</button>
            <button className="setting-btn"><MicIcon /></button>
            <button className="setting-btn"><VideocamIcon /></button>
            <button className="stream-option" onClick={Joinstream}><GroupIcon />&nbsp;&nbsp;Join stream</button>
          </div>
        </div>
